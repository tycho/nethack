...
extern void restore_trapset(struct memfile *mf, struct level *lev);
...
extern void save_occupations(struct memfile *mf);
extern void restore_occupations(struct memfile *mf, struct level *lev);
...
extern void drop_tipped(struct obj *, boolean);
...
extern int do_naming(struct obj *);
...
extern boolean Can_rise_up(const struct level *lev, int, int);
...
extern boolean In_W_tower(const struct level *lev, int, int);
...
extern void restore_food(struct memfile *mf, struct level *lev);
...
extern void del_engr(struct level *, struct engr *);
...
extern boolean bad_rock(const struct permonst *,boolean,xchar,xchar);
...
extern void losehp_how(int,const char *,int,int);
...
extern int doorganize(struct obj *);
...
extern void restore_pick(struct memfile *mf, struct level *lev);
...
extern boolean is_home_elemental(const struct d_level *dlev, const struct permonst *);
...
extern void bagotricks_monster(struct obj *, boolean);
...
extern void wallwalk_right(struct level *lev, xchar,xchar,schar,schar,schar,int);
...
extern void walkfrom(struct level *lev, int, int, schar);
...
extern void mkundead(struct level *lev, coord *mm, boolean revive_corpses, int mmflags);
...
extern void mondead_helper(struct monst *,int);
...
extern int newcham(struct level *,struct monst *,const struct permonst *,boolean,boolean);
...
extern int pronoun_gender(const struct level *,struct monst *);
...
extern void add_objitem(struct nh_objitem**, int*, enum nh_menuitem_role, int,
			int, const char*, struct obj*, boolean);
...
extern boolean is_quest_artifact(const struct obj *);
...
extern struct region* create_gas_cloud(struct level *lev, xchar, xchar,
				       int, int, int);
extern struct region* create_cthulhu_death_cloud(struct level *lev, xchar, xchar,
						 int, int, int);
...
extern struct obj *find_oid(struct level *lev, unsigned id);
...
extern void rloco_pos(struct obj *,struct level *,int *,int *);
