...
A("Dragonbane",			BROADSWORD,
	(SPFX_WARN_S|SPFX_RESTR|SPFX_DCLAS), 0, S_DRAGON,
...
A("Ogresmasher",		WAR_HAMMER,
	(SPFX_WARN_S|SPFX_RESTR|SPFX_DCLAS), 0, S_OGRE,
...
A("The Iron Ball of Liberation", HEAVY_IRON_BALL,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL), (SPFX_DISPL|SPFX_SEARCH|SPFX_WARN), 0,
	NO_ATTK,	NO_DFNS,	CARY(AD_MAGM),
