...
WEAPON("shuriken", "throwing star",
	0, 1, 0, 35,  3, 10,  8,  6, 2, P,   -P_SHURIKEN, IRON, HI_METAL),
...
WEAPON("short sword", NULL,
	1, 0, 0,  6, 30, 10,  6,  8, 1, P,   P_SHORT_SWORD, IRON, HI_METAL),
WEAPON("elven short sword", "runed short sword",
	0, 0, 0,  2, 30, 10,  8,  8, 1, P,   P_SHORT_SWORD, WOOD, HI_WOOD),
WEAPON("orcish short sword", "crude short sword",
	0, 0, 0,  3, 30, 10,  5,  8, 1, P,   P_SHORT_SWORD, IRON, CLR_BLACK),
WEAPON("dwarvish short sword", "broad short sword",
	0, 0, 0,  2, 30, 10,  7,  8, 1, P,   P_SHORT_SWORD, IRON, HI_METAL),
WEAPON("silver short sword", NULL,
	1, 0, 0,  2, 36, 50,  6,  8, 1, P,   P_SHORT_SWORD, SILVER, HI_SILVER),
...
HELM("elven leather helm", "leather hat",
		0, 0,  0,	6, 1,  3,   8, 1, 0, LEATHER, HI_LEATHER),
HELM("orcish helm", "iron skull cap",
		0, 0,  0,	6, 1, 30,  10, 1, 0, IRON, CLR_BLACK),
HELM("dwarvish iron helm", "hard hat",
		0, 0,  0,	6, 1, 40,  20, 2, 0, IRON, HI_METAL),
HELM("fedora", NULL,
		1, 0,  0,	0, 0,  3,   1, 0, 0, CLOTH, CLR_BROWN),
HELM("cornuthaum", "conical hat",
		0, 1,  CLAIRVOYANT,
				3, 1,  4,  80, 0, 2, CLOTH, CLR_BLUE),
HELM("dunce cap", "conical hat",
		0, 1,  0,	3, 1,  4,   1, 0, 0, CLOTH, CLR_BLUE),
HELM("dented pot", NULL,
		1, 0,  0,	1, 0, 10,   8, 1, 0, IRON, CLR_BLACK),
HELM("tinfoil hat", NULL,
		1, 0,  0,	1, 0,  0,   1, 0, 0, METAL, HI_METAL),
/* With shuffled appearances... */
HELM("helmet", "plumed helmet",
		0, 0,  0,      10, 1, 30,  10, 1, 0, IRON, HI_METAL),
HELM("helm of brilliance", "etched helmet",
		0, 1,  0,	6, 1, 50,  50, 1, 0, IRON, CLR_GREEN),
HELM("helm of opposite alignment", "crested helmet",
		0, 1,  0,	6, 1, 50,  50, 1, 0, IRON, HI_METAL),
HELM("helm of telepathy", "visored helmet",
		0, 1,  TELEPAT, 2, 1, 50,  50, 1, 0, IRON, HI_METAL),
...
DRGN_ARMR("magic dragon scale mail", "tatzelworm scale mail",
	1, ANTIMAGIC,  1200, 5, CLR_GRAY),
DRGN_ARMR("reflecting dragon scale mail", "amphitere scale mail",
	1, REFLECTING, 1200, 5, DRAGON_SILVER),
DRGN_ARMR("fire dragon scale mail", "draken scale mail",
	1, FIRE_RES,    900, 5, CLR_RED),
DRGN_ARMR("ice dragon scale mail", "lindworm scale mail",
	1, COLD_RES,    900, 5, CLR_WHITE),
DRGN_ARMR("sleep dragon scale mail", "sarkany scale mail",
	1, SLEEP_RES,   900, 5, CLR_ORANGE),
DRGN_ARMR("disintegration dragon scale mail", "sirrush scale mail",
	1, DISINT_RES, 1200, 5, CLR_BLACK),
DRGN_ARMR("electric dragon scale mail", "leviathan scale mail",
	1, SHOCK_RES,   900, 5, CLR_BLUE),
DRGN_ARMR("poison dragon scale mail", "wyvern scale mail",
	1, POISON_RES,  900, 5, CLR_GREEN),
DRGN_ARMR("stone dragon scale mail", "gold dragon scale mail",
	1, STONE_RES,   900, 5, HI_GOLD),
DRGN_ARMR("acid dragon scale mail", "guivre scale mail",
	1, ACID_RES,    900, 5, CLR_YELLOW),
DRGN_ARMR("chromatic dragon scale mail", "chromatic dragon scale mail",
	1, POISON_RES, 2400, 5, CLR_MAGENTA), /* intrinsics are set manually */

/* For now, only dragons leave these. */
/* 3.4.1: dragon scales left classified as "non-magic"; they confer
   magical properties but are produced "naturally" */
DRGN_ARMR("magic dragon scales", "tatzelworm scales",
	0, ANTIMAGIC,  700, 1, CLR_GRAY),
DRGN_ARMR("reflecting dragon scales", "amphitere scales",
	0, REFLECTING, 700, 1, DRAGON_SILVER),
DRGN_ARMR("fire dragon scales", "draken scales",
	0, FIRE_RES,   500, 1, CLR_RED),
DRGN_ARMR("ice dragon scales", "lindworm scales",
	0, COLD_RES,   500, 1, CLR_WHITE),
DRGN_ARMR("sleep dragon scales", "sarkany scales",
	0, SLEEP_RES,  500, 1, CLR_ORANGE),
DRGN_ARMR("disintegration dragon scales", "sirrush scales",
	0, DISINT_RES, 700, 1, CLR_BLACK),
DRGN_ARMR("electric dragon scales", "leviathan scales",
	0, SHOCK_RES,  500, 1, CLR_BLUE),
DRGN_ARMR("poison dragon scales", "wyvern scales",
	0, POISON_RES, 500, 1, CLR_GREEN),
DRGN_ARMR("stone dragon scales", "gold dragon scales",
	0, STONE_RES,  500, 1, HI_GOLD),
DRGN_ARMR("acid dragon scales", "guivre scales",
	0, ACID_RES,   500, 1, CLR_YELLOW),
DRGN_ARMR("chromatic dragon scales", "chromatic dragon scales",
	0, 0,         1500, 1, CLR_MAGENTA), /* intrinsics are set manually */
#undef DRGN_ARMR

ARMOR("plate mail", NULL,
	1, 0, 1, 0,	44, 5, 450, 600,  7, 2, ARM_SUIT, IRON, HI_METAL),
ARMOR("crystal plate mail", NULL,
	1, 0, 1, 0,	10, 5, 450, 820,  7, 2, ARM_SUIT, GLASS, CLR_WHITE),
ARMOR("bronze plate mail", NULL,
	1, 0, 1, 0,	25, 5, 450, 400,  6, 0, ARM_SUIT, COPPER, HI_COPPER),
ARMOR("splint mail", NULL,
	1, 0, 1, 0,	62, 5, 400,  80,  6, 1, ARM_SUIT, IRON, HI_METAL),
ARMOR("banded mail", NULL,
	1, 0, 1, 0,	72, 5, 350,  90,  6, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("dwarvish mithril-coat", NULL,
	1, 0, 0, 0,	10, 1, 150, 240,  6, 3, ARM_SUIT, MITHRIL, HI_METAL),
...
ARMOR("orcish chain mail", "crude chain mail",
	0, 0, 0, 0,	20, 5, 300,  75,  4, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("scale mail", NULL,
	1, 0, 0, 0,	72, 5, 250,  45,  4, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("studded leather armor", NULL,
	1, 0, 0, 0,	72, 3, 200,  15,  3, 1, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("ring mail", NULL,
	1, 0, 0, 0,	72, 5, 250, 100,  3, 0, ARM_SUIT, IRON, HI_METAL),
ARMOR("orcish ring mail", "crude ring mail",
	0, 0, 0, 0,	20, 5, 250,  80,  2, 1, ARM_SUIT, IRON, CLR_BLACK),
ARMOR("leather armor", NULL,
	1, 0, 0, 0,	82, 3, 150,   5,  2, 0, ARM_SUIT, LEATHER, HI_LEATHER),
ARMOR("leather jacket", NULL,
	1, 0, 0, 0,	12, 0,	30,  10,  1, 0, ARM_SUIT, LEATHER, CLR_BLACK),

/* shirts */
ARMOR("Hawaiian shirt", NULL,
	1, 0, 0, 0,	 8, 0,	 5,   3,  0, 0, ARM_SHIRT, CLOTH, CLR_MAGENTA),
ARMOR("striped shirt", NULL,
	1, 0, 0, 0,	 0, 0,	 5,   2,  0, 0, ARM_SHIRT, CLOTH, CLR_GRAY),
ARMOR("T-shirt", NULL,
	1, 0, 0, 0,	 2, 0,	 5,   2,  0, 0, ARM_SHIRT, CLOTH, CLR_WHITE),

/* cloaks */
/*  'cope' is not a spelling mistake... leave it be */
CLOAK("mummy wrapping", NULL,
		1, 0,	0,	    0, 0,  3,  2,  0, 1, CLOTH, CLR_GRAY),
CLOAK("elven cloak", "faded pall",
		0, 1,	STEALTH,    8, 0, 10, 60,  1, 3, CLOTH, CLR_BLACK),
CLOAK("orcish cloak", "coarse mantelet",
		0, 0,	0,	    8, 0, 10, 40,  0, 2, CLOTH, CLR_BLACK),
CLOAK("dwarvish cloak", "hooded cloak",
		0, 0,	0,	    8, 0, 10, 50,  0, 2, CLOTH, HI_CLOTH),
CLOAK("oilskin cloak", "slippery cloak",
		0, 0,	0,	    8, 0, 10, 50,  1, 3, CLOTH, HI_CLOTH),
CLOAK("robe", NULL,
		1, 1,	0,	    3, 0, 15, 50,  2, 3, CLOTH, CLR_RED),
CLOAK("alchemy smock", "apron",
		0, 1,	POISON_RES, 9, 0, 10, 50,  1, 1, CLOTH, CLR_WHITE),
CLOAK("leather cloak", NULL,
		1, 0,	0,	    8, 0, 15, 40,  1, 1, LEATHER, CLR_BROWN),
/* With shuffled appearances... */
CLOAK("cloak of protection", "tattered cape",
		0, 1,	PROTECTION, 9, 0, 10, 50,  3, 3, CLOTH, HI_CLOTH),
CLOAK("cloak of invisibility", "opera cloak",
		0, 1,	INVIS,	   10, 0, 10, 60,  1, 2, CLOTH, CLR_BRIGHT_MAGENTA),
CLOAK("cloak of magic resistance", "ornamental cope",
		0, 1,	ANTIMAGIC,  2, 0, 10, 60,  1, 3, CLOTH, CLR_WHITE),
CLOAK("cloak of displacement", "piece of cloth",
		0, 1,	DISPLACED, 10, 0, 10, 50,  1, 2, CLOTH, HI_CLOTH),

/* shields */
SHIELD("small shield", NULL,
		1, 0, 0, 0,	     6, 0, 30,	3,  1, 0, WOOD, HI_WOOD),
SHIELD("elven shield", "blue and green shield",
		0, 0, 0, 0,	     2, 0, 40,	7,  2, 0, WOOD, CLR_GREEN),
SHIELD("Uruk-hai shield", "white-handed shield",
		0, 0, 0, 0,	     2, 0, 50,	7,  1, 0, IRON, HI_METAL),
SHIELD("orcish shield", "red-eyed shield",
		0, 0, 0, 0,	     2, 0, 50,	7,  1, 0, IRON, CLR_RED),
SHIELD("large shield", NULL,
		1, 0, 1, 0,	     7, 0,100, 10,  2, 0, IRON, HI_METAL),
SHIELD("dwarvish roundshield", "large round shield",
		0, 0, 0, 0,	     4, 0,100, 10,  2, 0, IRON, HI_METAL),
SHIELD("shield of reflection", "polished silver shield",
		0, 0, 0, REFLECTING, 3, 0, 50, 50,  2, 0, SILVER, HI_SILVER),
...
GLOVES("leather gloves", "old gloves",
		0, 0,  0,	  16, 1, 10,  8,  1, 0, LEATHER, HI_LEATHER),
GLOVES("gauntlets of fumbling", "padded gloves",
		0, 1,  FUMBLING,   8, 1, 10, 50,  1, 0, LEATHER, HI_LEATHER),
GLOVES("gauntlets of power", "riding gloves",
		0, 1,  0,	   8, 1, 30, 50,  1, 0, IRON, CLR_BROWN),
GLOVES("gauntlets of dexterity", "fencing gloves",
		0, 1,  0,	   8, 1, 10, 50,  1, 0, LEATHER, HI_LEATHER),

/* boots */
BOOTS("low boots", "walking shoes",
		0, 0,  0,	  25, 2, 10,  8,  1, 0, LEATHER, HI_LEATHER),
BOOTS("iron shoes", "hard shoes",
		0, 0,  0,	   7, 2, 50, 16,  2, 0, IRON, HI_METAL),
BOOTS("high boots", "jackboots",
		0, 0,  0,	  15, 2, 20, 12,  2, 0, LEATHER, HI_LEATHER),
/* With shuffled appearances... */
BOOTS("speed boots", "combat boots",
		0, 1,  FAST,	  12, 2, 20, 50,  1, 0, LEATHER, HI_LEATHER),
BOOTS("water walking boots", "jungle boots",
		0, 1,  WWALKING,  12, 2, 20, 50,  1, 0, LEATHER, HI_LEATHER),
BOOTS("jumping boots", "hiking boots",
		0, 1,  JUMPING,   12, 2, 20, 50,  1, 0, LEATHER, HI_LEATHER),
BOOTS("elven boots", "mud boots",
		0, 1,  STEALTH,   12, 2, 15,  8,  1, 0, LEATHER, HI_LEATHER),
BOOTS("kicking boots", "buckled boots",
		0, 1,  0,         12, 2, 15,  8,  1, 0, IRON, CLR_BROWN),
BOOTS("fumble boots", "riding boots",
		0, 1,  FUMBLING,  12, 2, 20, 30,  1, 0, LEATHER, HI_LEATHER),
BOOTS("levitation boots", "snow boots",
		0, 1,  LEVITATION,12, 2, 15, 30,  1, 0, LEATHER, HI_LEATHER),
#undef HELM
#undef CLOAK
#undef SHIELD
#undef GLOVES
...
RING(NULL, 0, "quartz",                       0,  0, 0, 0, 7, GLASS, HI_GLASS),
RING(NULL, 0, "porcelain",                    0,  0, 0, 0, 8, GLASS, HI_MINERAL),
RING(NULL, 0, "ceramic",                      0,  0, 0, 0, 8, GLASS, HI_MINERAL),
RING(NULL, 0, "ridged",                       0,  0, 0, 0, 8, IRON, HI_METAL),
RING(NULL, 0, "wedding",                      0,  0, 0, 0, 7, GEMSTONE, CLR_WHITE),
RING(NULL, 0, "mithril",                      0,  0, 0, 0, 5, MITHRIL, HI_METAL),
RING(NULL, 0, "platinum",                     0,  0, 0, 0, 3, PLATINUM, HI_METAL),
RING(NULL, 0, "jacinth",                      0,  0, 0, 0, 9, GEMSTONE, CLR_ORANGE),
RING(NULL, 0, "citrine",                      0,  0, 0, 0, 6, GEMSTONE, CLR_ORANGE),
RING(NULL, 0, "amber",                        0,  0, 0, 0, 2, GEMSTONE, CLR_BROWN),
RING(NULL, 0, "jet",                          0,  0, 0, 0, 7, GEMSTONE, CLR_BLACK),
RING(NULL, 0, "chrysoberyl",                  0,  0, 0, 0, 5, GEMSTONE, CLR_YELLOW),
RING(NULL, 0, "plastic",                      0,  0, 0, 0, 1, PLASTIC, CLR_WHITE),
#undef RING
...
AMULET(NULL,                      "warped",     0, 0),
AMULET(NULL,                      "convex",     0, 0),
AMULET(NULL,                      "lunate",     0, 0),
AMULET(NULL,                      "spiked",     0, 0),
AMULET(NULL,                      "rectangular",0, 0),
AMULET(NULL,                      "elliptic",   0, 0),
...
CONTAINER("chest", NULL,           1, 0, 0,  25,600,  16, WOOD, HI_WOOD),
CONTAINER("iron safe", NULL,       1, 0, 0,  10,900,  50, IRON, HI_METAL),
...
/* light sources (oc_uses_known set to stop obj->known from being clobbered) */
...
POTION(NULL, "squishy",                 0, 0,           0,   0, CLR_GREEN),
...
SCROLL(NULL,                    "MAPIRO MAHAMA DIROMAT",1,   0, 100), /* Wizardry */
SCROLL(NULL,                    "VAS CORP BET MANI",    1,   0, 100), /* Ultima */
...
SPELL("detect monsters", "leather-bound",P_DIVINATION_SPELL,43,  1, 1, 1, NODIR,     HI_LEATHER),
...
SPELL(NULL,              "colorful",    P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "dark",        P_NONE, 0, 0, 0, 1, 0, CLR_BLACK),
SPELL(NULL,              "spotted",     P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "faded",       P_NONE, 0, 0, 0, 1, 0, CLR_GRAY),
SPELL(NULL,              "long",        P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "rainbow",     P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "ochre",       P_NONE, 0, 0, 0, 1, 0, CLR_YELLOW),
SPELL(NULL,              "tattered",    P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "wide",        P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "big",         P_NONE, 0, 0, 0, 1, 0, CLR_GRAY),
SPELL(NULL,              "fuzzy",       P_NONE, 0, 0, 0, 1, 0, CLR_BROWN),
SPELL(NULL,              "black",       P_NONE, 0, 0, 0, 1, 0, CLR_BLACK),
SPELL(NULL,              "left-handed", P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "psychedelic", P_NONE, 0, 0, 0, 1, 0, CLR_BRIGHT_MAGENTA),
SPELL(NULL,              "spiral-bound",P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "stapled",     P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "stylish",     P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "tartan",      P_NONE, 0, 0, 0, 1, 0, CLR_RED),
SPELL(NULL,              "chartreuse",  P_NONE, 0, 0, 0, 1, 0, CLR_GREEN),
SPELL(NULL,              "decrepit",    P_NONE, 0, 0, 0, 1, 0, CLR_BROWN),
SPELL(NULL,              "paperback",   P_NONE, 0, 0, 0, 1, 0, HI_PAPER),
SPELL(NULL,              "crimson",     P_NONE, 0, 0, 0, 1, 0, CLR_RED),
SPELL(NULL,              "charcoal",    P_NONE, 0, 0, 0, 1, 0, CLR_BLACK),
...
WAND(NULL,             "jeweled",   0, 150, 1, 0,         GEMSTONE, HI_MINERAL),
WAND(NULL,             "black",     0, 150, 1, 0,         PLASTIC,  CLR_BLACK),
WAND(NULL,             "ceramic",   0, 150, 1, 0,         GLASS,    HI_MINERAL),
WAND(NULL,             "porcelain", 0, 150, 1, 0,         GLASS,    HI_MINERAL),
WAND(NULL,             "quartz",    0, 150, 1, 0,         GLASS,    HI_GLASS),
WAND(NULL,             "bronze",    0, 150, 1, 0,         COPPER,   HI_COPPER),
WAND(NULL,             "crusty",    0, 150, 1, 0,         IRON,     CLR_RED),
WAND(NULL,             "octagonal", 0, 150, 1, 0,         IRON,     HI_METAL),
WAND(NULL,             "bamboo",    0, 150, 1, 0,         WOOD,     CLR_YELLOW),
WAND(NULL,             "walnut",    0, 150, 1, 0,         WOOD,     HI_WOOD),
WAND(NULL,             "mahogany",  0, 150, 1, 0,         WOOD,     HI_WOOD),
WAND(NULL,             "cedar",     0, 150, 1, 0,         WOOD,     HI_WOOD),
WAND(NULL,             "chrome",    0, 150, 1, 0,         METAL,    HI_SILVER),
WAND(NULL,             "titanium",  0, 150, 1, 0,         METAL,    HI_METAL),
WAND(NULL,             "nickel",    0, 150, 1, 0,         METAL,    HI_METAL),
WAND(NULL,             "mithril",   0, 150, 1, 0,         MITHRIL,  HI_METAL),
WAND(NULL,             "grooved",   0, 150, 1, 0,         WOOD,     HI_WOOD),
WAND(NULL,             "bent",      0, 150, 1, 0,         IRON,     HI_METAL),
WAND(NULL,             "plastic",   0, 150, 1, 0,         PLASTIC,  CLR_BLACK),
WAND(NULL,             "bone",      0, 150, 1, 0,         BONE,     CLR_WHITE),
WAND(NULL,             "alabaster", 0, 150, 1, 0,         MINERAL,  CLR_BROWN),
WAND(NULL,             "orichalcum",0, 150, 1, 0,         METAL,    HI_METAL),
WAND(NULL,             "electrum",  0, 150, 1, 0,         METAL,    HI_GOLD),
#undef WAND
