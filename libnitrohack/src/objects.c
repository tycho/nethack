...
RING("gain constitution", 0, "opal",        150, 1, 1, 7, GEMSTONE,  HI_MINERAL),
...
RING(NULL, 0, "obsidian",                     0, 0, 0, 7, GEMSTONE, CLR_BLACK),
RING(NULL, 0, "plain",                        0, 0, 0, 7, MINERAL, HI_MINERAL),
RING(NULL, 0, "glass",                        0, 0, 0, 7, GLASS, HI_GLASS),
RING(NULL, 0, "quartz",                       0, 0, 0, 7, GLASS, HI_GLASS),
RING(NULL, 0, "porcelain",                    0, 0, 0, 8, GLASS, HI_MINERAL),
RING(NULL, 0, "ceramic",                      0, 0, 0, 8, GLASS, HI_MINERAL),
RING(NULL, 0, "ridged",                       0, 0, 0, 8, IRON, HI_METAL),
RING(NULL, 0, "wedding",                      0, 0, 0, 7, GEMSTONE, CLR_WHITE),
RING(NULL, 0, "mithril",                      0, 0, 0, 5, MITHRIL, HI_METAL),
RING(NULL, 0, "platinum",                     0, 0, 0, 3, PLATINUM, HI_METAL),
RING(NULL, 0, "jacinth",                      0, 0, 0, 9, GEMSTONE, CLR_ORANGE),
RING(NULL, 0, "citrine",                      0, 0, 0, 6, GEMSTONE, CLR_ORANGE),
RING(NULL, 0, "amber",                        0, 0, 0, 2, GEMSTONE, CLR_BROWN),
RING(NULL, 0, "jet",                          0, 0, 0, 7, GEMSTONE, CLR_BLACK),
RING(NULL, 0, "chrysoberyl",                  0, 0, 0, 5, GEMSTONE, CLR_YELLOW),
RING(NULL, 0, "plastic",                      0, 0, 0, 1, PLASTIC, CLR_WHITE),
#undef RING
