...
RING("adornment", ADORNED, "wooden",        100, 35, 1, 1, 2, WOOD, HI_WOOD),
RING("gain strength", 0, "granite",         150, 35, 1, 1, 7, MINERAL, HI_MINERAL),
RING("gain constitution", 0, "opal",        150, 35, 1, 1, 7, GEMSTONE,  HI_MINERAL),
RING("increase accuracy", 0, "clay",        150, 35, 1, 1, 4, MINERAL, CLR_RED),
RING("increase damage", 0, "coral",         150, 35, 1, 1, 4, MINERAL, CLR_ORANGE),
RING("protection", PROTECTION, "black onyx",100, 35, 1, 1, 7, MINERAL, CLR_BLACK),
RING("regeneration", REGENERATION, "moonstone",
					    200, 35, 1, 0, 6, MINERAL, HI_MINERAL),
RING("searching", SEARCHING, "tiger eye",   200, 35, 1, 0, 6, GEMSTONE, CLR_BROWN),
RING("stealth", STEALTH, "jade",            100, 36, 1, 0, 6, GEMSTONE, CLR_GREEN),
RING("sustain ability", FIXED_ABIL, "bronze",
					    100, 36, 1, 0, 4, COPPER, HI_COPPER),
RING("levitation", LEVITATION, "agate",     200, 36, 1, 0, 7, GEMSTONE, CLR_RED),
RING("hunger", HUNGER, "topaz",             100, 36, 1, 0, 8, GEMSTONE, CLR_CYAN),
RING("aggravate monster", AGGRAVATE_MONSTER, "sapphire",
					    150, 36, 1, 0, 9, GEMSTONE, CLR_BLUE),
RING("conflict", CONFLICT, "ruby",          300, 36, 1, 0, 9, GEMSTONE, CLR_RED),
RING("warning", WARNING, "diamond",         100, 36, 1, 0,10, GEMSTONE, CLR_WHITE),
RING("poison resistance", POISON_RES, "pearl",
					    150, 36, 1, 0, 4, BONE, CLR_WHITE),
RING("fire resistance", FIRE_RES, "iron",   200, 36, 1, 0, 5, IRON, HI_METAL),
RING("cold resistance", COLD_RES, "brass",  150, 36, 1, 0, 4, COPPER, HI_COPPER),
RING("shock resistance", SHOCK_RES, "copper",
					    150, 36, 1, 0, 3, COPPER, HI_COPPER),
RING("free action",     FREE_ACTION, "twisted",
					    200, 36, 1, 0, 6, IRON, HI_METAL),
RING("slow digestion",  SLOW_DIGESTION, "steel",
					    200, 36, 1, 0, 8, IRON, HI_METAL),
RING("teleportation", TELEPORT, "silver",   200, 36, 1, 0, 3, SILVER, HI_SILVER),
RING("teleport control", TELEPORT_CONTROL, "gold",
					    300, 36, 1, 0, 3, GOLD, HI_GOLD),
RING("polymorph", POLYMORPH, "ivory",       300, 36, 1, 0, 4, BONE, CLR_WHITE),
RING("polymorph control", POLYMORPH_CONTROL, "emerald",
					    300, 36, 1, 0, 8, GEMSTONE, CLR_BRIGHT_GREEN),
RING("invisibility", INVIS, "wire",         150, 36, 1, 0, 5, IRON, HI_METAL),
RING("see invisible", SEE_INVIS, "engagement",
					    150, 36, 1, 0, 5, IRON, HI_METAL),
RING("protection from shape changers", PROT_FROM_SHAPE_CHANGERS, "shiny",
					    100, 36, 1, 0, 5, IRON, CLR_BRIGHT_CYAN),
RING(NULL, 0, "obsidian",                     0,  0, 0, 0, 7, GEMSTONE, CLR_BLACK),
RING(NULL, 0, "plain",                        0,  0, 0, 0, 7, MINERAL, HI_MINERAL),
RING(NULL, 0, "glass",                        0,  0, 0, 0, 7, GLASS, HI_GLASS),
...
POTION(NULL, "burgundy",                0, 0,           0,   0, CLR_RED),
POTION(NULL, "ochre",                   0, 0,           0,   0, CLR_BROWN),
POTION(NULL, "mauve",                   0, 0,           0,   0, CLR_MAGENTA),
