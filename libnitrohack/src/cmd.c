...
const struct cmd_desc cmdlist[] = {
	...
	{"verhistory", "display the version history", 0, 0, TRUE, doverhistory, CMD_HELP | CMD_ARG_NONE | CMD_NOTIME | CMD_EXT},
	...
	{"whatis", "describe what a symbol means", '/', 0, TRUE, dowhatis, CMD_HELP | CMD_ARG_NONE | CMD_NOTIME},
