...
extern int FDECL(get_floor_type, (int));
extern int FDECL(get_room_type, (char *));
extern int FDECL(get_trap_type, (char *));
extern int FDECL(get_monster_id, (char *,int));
extern int FDECL(get_object_id, (char *,int));
extern bool FDECL(check_monster_char, (int));
extern bool FDECL(check_object_char, (int));
extern char FDECL(what_map_char, (int));
