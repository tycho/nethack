...
int  NDECL (yywrap);
int FDECL(get_floor_type, (int));
int FDECL(get_room_type, (char *));
int FDECL(get_trap_type, (char *));
int FDECL(get_monster_id, (char *,int));
int FDECL(get_object_id, (char *,int));
bool FDECL(check_monster_char, (int));
bool FDECL(check_object_char, (int));
char FDECL(what_map_char, (int));
 ...
 */
int get_monster_id(char *s, int c)
{
	int i, class;
 ...
 */
void check_coord(int x, int y, const char *str)
{
    char ebuf[60];
