...
# ifdef OVL1
STATIC_DCL bool FDECL(u_slip_free, (struct monst *,struct attack *));
...
STATIC_DCL int FDECL(explmu, (struct monst *,struct attack *,bool));
STATIC_DCL void FDECL(missmu,(struct monst *,bool,struct attack *));
...
STATIC_OVL void missmu(		/* monster missed you */
	struct monst *mtmp,
	bool nearmiss,
	struct attack *mattk
)
...
STATIC_OVL void mswings(		/* monster swings obj */
	struct monst *mtmp,
	struct obj *otemp
)
{
...
STATIC_OVL void wildmiss(		/* monster attacked your displaced image */
	struct monst *mtmp,
	struct attack *mattk
)
{
...
STATIC_OVL bool u_slip_free(struct monst *mtmp, struct attack *mattk)
{
...
STATIC_OVL int gulpmu(	/* monster swallows you, or damage if u.uswallow */
	struct monst *mtmp,
	struct attack *mattk
)
{
...
STATIC_OVL int explmu(	/* monster explodes in your face */
	struct monst *mtmp,
	struct attack *mattk,
	bool ufound
)
...
int gazemu(	/* monster gazes at you */
	struct monst *mtmp,
	struct attack *mattk
)
{
...
void mdamageu(	/* mtmp hits you for n points damage */
	struct monst *mtmp,
	int n
)
{
