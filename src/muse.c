...
STATIC_OVL void mzapmsg(struct monst *mtmp, struct obj *otmp, bool self)
{
	if (!canseemon(mtmp)) {
		if (flags.soundok)
			You_hear("a %s zap.",
...
STATIC_OVL void mon_consume_unstone(struct monst *mon, struct obj *obj, bool by_you, bool stoning)
{
