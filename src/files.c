 ...
 */
char *fname_encode(const char *legal, int quotechar, char *s, char *callerbuf, int bufsz)
{
	char *sp, *op;
	int cnt = 0;
 ...
 *	bufsz		size of callerbuf
 */
char *fname_decode(int quotechar, char *s, char *callerbuf, int bufsz)
{
	char *sp, *op;
	int k,calc,cnt = 0;
	static char hexdigits[] = "0123456789ABCDEF";
 ...
 */
STATIC_OVL char *set_bonestemp_name(void)
{
	char *tf;
...
#ifdef WIZARD
STATIC_OVL FILE *fopen_wizkit_file(void)
{
	FILE *fp;
