...
STATIC_OVL void reorder_invent(void)
{
...
STATIC_OVL char obj_to_let(struct obj *obj)	/* should of course only be called for things in invent */
{
#ifndef GOLDOBJ
	if (obj->oclass == COIN_CLASS)
		return GOLD_SYM;
 ...
 */
#ifdef DUMP_LOG
static char display_pickinv(const char *lets, bool want_reply, long *out_cnt,
...
STATIC_OVL bool this_type_only(struct obj *obj)
{
...
STATIC_OVL bool mergable(struct obj *otmp, struct obj *obj)	/* returns TRUE if obj  & otmp can be merged */
{
...
STATIC_OVL bool tool_in_use(struct obj *obj)
{
...
STATIC_OVL void invdisp_nothing(const char *hdr, const char *txt)
{
	winid win;
	anything any;
	menu_item *selected;
...
STATIC_OVL bool worn_wield_only(struct obj *obj)
{
...
STATIC_OVL bool only_here(struct obj *obj)
{
