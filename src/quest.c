...
STATIC_OVL void on_locate(void)
{
...
STATIC_OVL bool not_capable(void)
{
...
STATIC_OVL void chat_with_leader(void)
{
...
STATIC_OVL void chat_with_nemesis(void)
{
...
STATIC_OVL void chat_with_guardian(void)
{
