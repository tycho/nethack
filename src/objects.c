...
HELM("helm of brilliance", "etched helmet",
		0, 1,  0,	5, 1, 50,  50, 9, 0, IRON, CLR_GREEN),
...
SHIELD("flame shield", "dark red shield",
		0, 1, 0, FIRE_RES, 0, 0, 50, 300, 8, 5, IRON, CLR_RED),
SHIELD("ice shield", "dark blue shield",
		0, 1, 0, COLD_RES, 0, 0, 50, 300, 8, 5, IRON, CLR_BLUE),
SHIELD("lightning shield", "dull yellow shield",
		0, 1, 0, SHOCK_RES, 0, 0, 50, 300, 8, 5, IRON, CLR_YELLOW),
SHIELD("venom shield", "dark green shield",
		0, 1, 0, POISON_RES, 0, 0, 50, 300, 8, 5, IRON, CLR_GREEN),
SHIELD("shield of light", "shiny shield",
		0, 1, 0, 0, 0, 0, 50, 300, 8, 5, IRON, CLR_YELLOW),
SHIELD("shield of mobility", "slippery shield",
		0, 1, 0, FREE_ACTION, 0, 0, 50, 300, 9, 4, IRON, HI_METAL),
...
SPELL("invisibility",    "dark brown",  P_ESCAPE_SPELL, 20,  5, 4, 1, NODIR,     CLR_BROWN),
...
SPELL("jumping",			 "thin",        P_ESCAPE_SPELL, 15,  3, 1, 1, IMMEDIATE, HI_PAPER),
