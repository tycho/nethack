...
STATIC_OVL void kickdmg(struct monst *mon, bool clumsy)
{
	int mdx, mdy;
 ...
 */
bool ship_object(struct obj *otmp, xchar x, xchar y, bool shop_floor_obj)
{
	schar toloc;
	xchar ox, oy;
	coord cc;
...
STATIC_OVL void otransit_msg(struct obj *otmp, bool nodrop, long num)
{
	char obuf[BUFSZ];
