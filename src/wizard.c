...
STATIC_DCL bool FDECL(mon_has_arti, (struct monst *,int));
STATIC_DCL struct monst *FDECL(other_mon_has_arti, (struct monst *,int));
STATIC_DCL struct obj *FDECL(on_ground, (int));
