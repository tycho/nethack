...
#if !defined (OS_DETECTED)
#if defined (__ultrix__) || defined (__ultrix) || defined (ultrix)
#define OS_DETECTED
#define TARGET_OS_ULTRIX
#endif
#endif

#if !defined (OS_DETECTED)
#if defined (_hpux) || defined (__hpux) || defined (hpux)
#define OS_DETECTED
#define TARGET_OS_HPUX
#endif
#endif
