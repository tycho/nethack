...
#ifdef OPT_DISPMAP
	bool  fast_map;	/* use optimized, less flexible map display */
#endif
...
struct instance_flags {
    ...
    bool  cursesgraphics;    /* Use portable curses extended characters */
#endif
...
#ifdef SIMPLE_MAIL
	bool simplemail;	/* simple mail format $NAME:$MESSAGE */
#endif
#ifdef WIZARD
...
#endif
#ifdef MFLOPPY
	bool  checkspace;	/* check disk space before writing files */
	...
	bool  MACgraphics;	/* use Macintosh extended character set, as
...
#endif
#ifdef MSDOS
	bool hasvga;		/* has a vga adapter */
	bool usevga;		/* use the vga adapter */
	bool grmode;		/* currently in graphics mode */
#endif
#ifdef LAN_FEATURES
	...
	bool  paranoid_quit; /* Ask for 'yes' when quitting */
	bool  paranoid_remove; /* Always show menu for 'T' and 'R' */
#endif
#ifdef SHOW_BORN
	bool show_born;	/* show numbers of created monsters */
#endif
#ifdef SORTLOOT
 ...
 */
	...
	bool wc2_darkgray;		/* try to use PC dark-gray color
					 * to represent black object */

	bool show_buc;	/* always show BUC status */
