...
E void FDECL(positionpopup,(Widget,bool));
...
E void FDECL(create_message_window,(struct xwindow*, bool, Widget));
...
E void FDECL(create_map_window,(struct xwindow*, bool, Widget));
...
/* ### winstatus.c ### */
E void FDECL(create_status_window,(struct xwindow*, bool, Widget));
...
E void FDECL(display_text_window,(struct xwindow*, bool));
...
E void FDECL(append_text_buffer,(struct text_buffer*, const char*, bool)); /* text buffer routines */
...
E void FDECL(X11_display_nhwindow, (winid, bool));
