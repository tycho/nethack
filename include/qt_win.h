...
public:
	...
	static void qt_display_nhwindow(winid wid, bool block);
	...
	static void qt_display_file(const char *filename, bool must_exist);
	...
	static void qt_print_glyph(winid wid,xchar x,xchar y,int glyph);
	...
	static char qt_yn_function(const char *question, const char *choices, char def);
