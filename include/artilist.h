...
A("Demonbane",			LONG_SWORD,
	...
	PHYS(8,20),	DRLI(0,0),	NO_CARY,	0, A_LAWFUL, NON_PM, NON_PM, 2500L ),

A("Werebane",			SILVER_SABER,
	(SPFX_WARN|SPFX_RESTR|SPFX_DFLAG2), 0, M2_WERE,
	PHYS(8,20),	DFNS(AD_WERE),	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 1500L ),
...
A("Giantslayer",		LONG_SWORD,
	...
	PHYS(8,20),	NO_DFNS,	NO_CARY,	0, A_NEUTRAL, NON_PM, NON_PM, 200L ),

A("Ogresmasher",		WAR_HAMMER,
	(SPFX_WARN|SPFX_RESTR|SPFX_DCLAS), 0, S_OGRE,
	PHYS(8,20),	NO_DFNS,	NO_CARY,	0, A_NONE, NON_PM, NON_PM, 200L ),
...
A("Sunsword",			LONG_SWORD,
	(SPFX_BLIND|SPFX_WARN|SPFX_RESTR|SPFX_DFLAG2), 0, M2_UNDEAD,
